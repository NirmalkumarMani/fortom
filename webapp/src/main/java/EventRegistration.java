...
public class EventRegistration extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
        ...
        try {
            ...
            String sql="insert into User(firstname,lastname,email,date,time,topic,location)values(?,?,?,?,?,?,?)";
            ...
            while (rs.next()) {
                pw.println("<tr><td>" + rs.getString(1) + "<td>" + rs.getString(2)  + "<td>" + rs.getString(3) + "<td>" + rs.getString(4) + "<td>" + rs.getString(5) + "<td>" + "<td>"
